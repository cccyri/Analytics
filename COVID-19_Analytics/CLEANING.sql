...
--if we have two same ID's and the second one is empty, populate it with the first data
...
-- Change Y and N to Yes and No in "Sold as Vacant" field beacuse N/Y is less relevant
